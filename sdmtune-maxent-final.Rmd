...
Sofar, it seems that cross validation only improves model accuracy (measured via AUC) for plots with larger data sets. Model performance with cross-validation will be compared to performance without cross-validation.
...
__NOTE:__ Need to consider wheter to use the Jackknife AUC test. When this is false, the percent contribution is used instead.
