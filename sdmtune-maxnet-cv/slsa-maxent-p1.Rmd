...
# NOTE: When size of 400+ is sepected returns
...
bg_coords1 <- bg_points %>% dplyr::select(c(x,y))
...
swd_obj <- prepareSWD(species = "CA Slender Salamander",
                      ...
                      a = bg_coords1, # background point coordinates
