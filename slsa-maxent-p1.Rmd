...
predictor_stack2 <- raster::stack(x = predictor_stack)
plot(predictor_stack2)

# convert occurence from sf to sp
occurence_p1_subset <- as_Spatial(occurence_p1)

elev1 <- raster::raster(elev)

# best attempt RIP
maxent(elev1, occurence_p1_subset, removeDuplicates=TRUE)
