...
subtitle: "Default MaxEnt values"
...
source(knitr::purl(here("slsa-maxent", "maxent-function.Rmd")))
```
...
```{r}
## ......................Plot 1....................
maxent_p1 <- slsa_maxent(plot_number = 1, new_crs = "WGS84")
pred_map_p1 <- predict(maxent_p1, pred_stack_rast_p1)

## ......................Plot 2....................
maxent_p2 <- slsa_maxent(plot_number = 2, new_crs = "WGS84")
pred_map_p2 <- predict(maxent_p2, pred_stack_rast_p2)

## ......................Plot 3....................
maxent_p3 <- slsa_maxent(plot_number = 3, new_crs = "WGS84")
pred_map_p3 <- predict(maxent_p3, pred_stack_rast_p3)

## ......................Plot 4....................
maxent_p4 <- slsa_maxent(plot_number = 4, new_crs = "WGS84")
pred_map_p4 <- predict(maxent_p4, pred_stack_rast_p4)

## ......................Plot 5....................
maxent_p5 <- slsa_maxent(plot_number = 5, new_crs = "WGS84")
pred_map_p5 <- predict(maxent_p5, pred_stack_rast_p5)

## ......................Plot 6....................
maxent_p6 <- slsa_maxent(plot_number = 6, new_crs = "WGS84")
pred_map_p6 <- predict(maxent_p6, pred_stack_rast_p6)

## ......................Plot 7....................
maxent_p7 <- slsa_maxent(plot_number = 7, new_crs = "WGS84")
pred_map_p7 <- predict(maxent_p7, pred_stack_rast_p7)

## ......................Plot 8....................
maxent_p8 <- slsa_maxent(plot_number = 8, new_crs = "WGS84")
...
# tmap_save(tm = mp_1, filename = here("outputs", "default-maxent", 
...
# tmap_save(tm = mp_2, filename = here("outputs", "default-maxent", 
...
# tmap_save(tm = mp_3, filename = here("outputs", "default-maxent", 
...
# tmap_save(mp_4, filename = here("outputs", "default-maxent", 
...
# tmap_save(mp_5, filename = here("outputs", "default-maxent", 
...
# tmap_save(mp_6, filename = here("outputs", "default-maxent", 
...
# tmap_save(mp_7, filename = here("outputs", "default-maxent", 
...
# tmap_save(mp_8, filename = here("outputs", "default-maxent", 
